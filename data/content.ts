...
export const profile = {
  ...
  status: "open to work",
  headline: "High-stakes interfaces, shipped fast.",
  intro:
    "I build React + TypeScript frontends for products where the interface carries real risk — underwriting workstations, trading platforms, on-chain claims. Four years across AI-native B2B SaaS and Web3, mostly in 0-to-1 environments where requirements are ambiguous and shipping speed matters.",
  links: {
    ...
    // TODO: host your resume PDF (e.g. in /public) and update this path
...
export const reviewFields = [
  ...
  { field: "experience", value: "4 yrs · fintech / Web3 / AI-native" },
    ...
    sections: [
      {
        ...
        body:
          "Underwriting data is deeply nested and interdependent: a single submission spans dozens of coverage sections, each with its own validation rules, and a change in one field can reprice the entire policy. On top of that, most field values arrive from an AI extraction pipeline — which means the UI has to make machine-generated data easy for a human to verify, correct, and trust.",
      },
      {
      ...
      },
      {
        ...
        body:
          "Driving forms from schemas instead of hand-writing them meant new coverage lines shipped in days, not weeks. Zod schemas doubled as the single source of truth for both validation and TypeScript types, which kept the deeply nested state honest. For the review UIs, the guiding rule was that a human should never have to trust the AI blindly: every extracted value stays visibly provisional until confirmed.",
      },
      {
        heading: "Outcome",
        body:
          "Zero to a working beta used by design partners in roughly four months, with the team later selected for YC S26. The product is internal and non-public, so this page shows the architecture rather than screenshots — the diagram below is the generic shape of the system.",
      },
    ],
    metrics: [
    ...
    sections: [
      {
        ...
        body:
          "Developed the NFT trading platform that processed over $1M in transaction volume. Wallet interactions demand exactness: BigNumber precision end to end, defensive error handling around every signature and transaction state, and UIs that never show a user a number the chain would disagree with.",
      },
      {
        heading: "No-code claim tool",
        body:
          "Built a claim tool that let projects distribute NFTs without writing code — it processed 100K+ on-chain claims. The interesting work was keeping it fast and stable during network congestion, when gas spikes and pending transactions turn happy paths into edge cases.",
      },
      {
        heading: "FizzPop & design system",
        body:
          "Led frontend for the Web3 game FizzPop, focusing on rendering performance for smooth gameplay; the game reached 39% Day-1 retention, roughly 3–4x the category average. Also implemented the team's Tailwind CSS design system with Storybook, standardizing accessible components and shortening UI development cycles across the team.",
      },
    ],
    metrics: [
...
export const skills = [
  { group: "Frontend core", items: "React · Next.js · TypeScript · JavaScript (ES6+) · Tailwind CSS" },
...
export const education = [
  { name: "AppWorks School — Frontend Engineer Program", detail: "1,000+ hrs immersive training, 2022" },
